class SzolgBoxComponent extends HTMLElement {
  constructor() {
    ...
    <div class="container">
      ...
      <svg id="icon"> <use href="#tartalomIkon" ></use> </svg>
    ...
    let iconElement = this.shadowRoot.querySelector("#tartalomIkon");
    let bbox = iconElement.getBBox();
     ...
     this.shadowRoot.querySelector("#icon").setAttribute("fill",this.getAttribute("fillColor"));
